  ...
  return (
    ...
    >
      <div className="">
        ...
        <div className="bg-white backdrop-blur-xl pb-6 md:pb-2 lg:pb-2 shadow-xl border overflow-hidden border-gray-200 px-6 py-3 flex justify-between items-center">
